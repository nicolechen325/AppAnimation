package com.pa.chen.animation.loading;
...
public class ShapeLoadingView extends View {
    ...
    private void init() {
        ...
        mTriangleColor = getResources().getColor(R.color.triangle);//三角
        mCircleColor = getResources().getColor(R.color.circle);//圆形
        mRectColor = getResources().getColor(R.color.triangle);//正方形
    }
        ...
        switch (mShape) {
            ...
            case SHAPE_CIRCLE:
                ...
                if (mIsLoading) {
                    ...
                    Log.d("anima",magicNumber+"-----"+mAnimPercent);
                    mAnimPercent += 0.12;
