 ...
 *******************************************************************************/
package com.set.view.scroll.pulltorefresh;
...
import com.set.view.scroll.pulltorefresh.internal.FlipLoadingLayout;
import com.set.view.scroll.pulltorefresh.internal.LoadingLayout;
import com.set.view.scroll.pulltorefresh.internal.PillLoadingLayout;
import com.set.view.scroll.pulltorefresh.internal.RotateLoadingLayout;
import com.set.view.scroll.pulltorefresh.internal.Utils;
import com.set.view.scroll.pulltorefresh.internal.ViewCompat;
...
public abstract class PullToRefreshBase<T extends View> extends LinearLayout implements IPullToRefresh<T> {
	...
	private AnimationStyle mLoadingAnimationStyle = AnimationStyle.PILL;
	...
	protected LoadingLayout createLoadingLayout(Context context, Mode mode, TypedArray attrs) {
		...
		//在药丸样式下非下拉刷新的刷新样式都用默认的刷新样式
		if (AnimationStyle.PILL == mLoadingAnimationStyle && mode != Mode.PULL_FROM_START){
			layout = AnimationStyle.getDefault().createLoadingLayout(context, mode,
	...
	public static enum AnimationStyle {
		...
		LoadingLayout createLoadingLayout(Context context, Mode mode, Orientation scrollDirection, TypedArray attrs) {
			switch (this) {
				...
				case PILL:
					return new PillLoadingLayout(context, mode, scrollDirection, attrs);
			}
		}
	}
