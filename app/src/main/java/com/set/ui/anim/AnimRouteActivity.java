...
import com.set.ui.anim.sample.AnimEvaluatorActivity;
...
public class AnimRouteActivity extends BaseGridActivity {
    ...
    public List<RouteItemEntry> initItemData() {
        ...
        list.add(new RouteItemEntry(4, "估值器", AnimEvaluatorActivity.class));
        list.add(new RouteItemEntry(5, "Scroller弹性", ScrollerActivity.class));
        list.add(new RouteItemEntry(6, "图片快速Flash", FasterImageFlashActivity.class));
        list.add(new RouteItemEntry(7, "开门动画", OpenDoorActivity.class));
        list.add(new RouteItemEntry(8, "爆炸效果", ExplosionActivity.class));
        list.add(new RouteItemEntry(9, "Loading", LoadingActivity.class));
        list.add(new RouteItemEntry(10, "3d对话框动画", Anim3dActivity.class));
        return list;
    }
}
