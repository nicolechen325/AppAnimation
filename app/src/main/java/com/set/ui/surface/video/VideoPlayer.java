...
import com.set.ui.MyApplication;

import java.io.IOException;

/**
 * 播放器ui
 * 管理mediaplayer和控制ui的操作
 */
public class VideoPlayer extends FrameLayout implements IVideoPlayer,
    ...
    //和播放控制ui互相强连接，mContainer.addView添加视图，这里先分开
...
//        mContainer.addView(mController, params);
            ...
            new Handler().post(new Runnable() {
                ...
                public void run() {
                    ...
                    LayoutParams params = new LayoutParams(
                            ViewGroup.LayoutParams.MATCH_PARENT,
                            ViewGroup.LayoutParams.MATCH_PARENT);
                    VideoPlayer.this.addView(mContainer, params);
                }
            });
    ...
    public void enterTinyWindow() {
        ...
        new Handler().post(new Runnable() {
            ...
            public void run() {
                ...
                params.topMargin = VideoUtil.dp2px(mContext, 48f);
    ...
    private void openMediaPlayer() {
        ...
        try {
            ...
            mMediaPlayer.setSurface(mSurface);//和surface绑定才显示画面。。创建Surface，包装SurfaceTexture
    ...
    public void onPrepared(MediaPlayer mp) {
        ...
        if (continueFromLastPosition) {
            int savedPlayPosition = VideoUtil.getSavedPlayPosition(mContext, mUrl);
