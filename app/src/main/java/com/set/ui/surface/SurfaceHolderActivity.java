 ...
 *
 *
 * 直接用viewrootimpl中的surfaceholder
 *
 * 在performTraversals中有surfaceholder不空时的callback回调
 */
public class SurfaceHolderActivity extends AppCompatActivity implements SurfaceHolder.Callback2 {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //初始化ViewRootImpl内部mSurfaceHolder。
