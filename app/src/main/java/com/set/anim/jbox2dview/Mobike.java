package com.set.anim.jbox2dview;
...
public class Mobike {
    ...
    public void onDraw(Canvas canvas) {
        ...
        for (int i = 0; i < childCount; i++) {
            ...
            Body body = (Body) view.getTag(R.id.jbox2d_body_tag);
            if (body != null) {
    ...
    private void createBody(World world, View view) {
        ...
        Shape shape = null;
        Boolean isCircle = (Boolean) view.getTag(R.id.jbox2d_view_circle_tag);
        ...
        view.setTag(R.id.jbox2d_body_tag, body);
