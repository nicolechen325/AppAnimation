...
public class PropertyValuesHolder implements Cloneable {
     ...
     */
    Method mSetter = null;//用于设置目标的属性的方法  子类FloatPropertyValuesHolder和IntPropertyValuesHolder会有各自使用mSetter的方法
     ...
     */
    KeyframeSet mKeyframeSet = null;//包含Keyframe类型的集合 里面有个ArrayList
    ...
    public void setFloatValues(float... values) {
        ...
        mKeyframeSet = KeyframeSet.ofFloat(values);//返回的是FloatKeyframeSet类型的FrameSet,在FloatPropertyValuesHolder子类中会有强制转换
    }
     ...
     */
    void setupSetterAndGetter(Object target) {//initAnimation函数中会调用 通过setupSetter函数 给mSetter赋值
        if (mProperty != null) {
     ...
     *
     * 被ObjectorAnimator调用 动画过程中将计算的值设置到目标view上
    ...
    void setAnimatedValue(Object target) {
        ...
        if (mSetter != null) {
            try {
                mTmpValueArray[0] = getAnimatedValue();//只有一个元素的数组  存放获取的值mAnimatedValue
     ...
     */
    void calculateValue(float fraction) {//计算动画当前的值
    ...
    static class IntPropertyValuesHolder extends PropertyValuesHolder {
        ...
        void setAnimatedValue(Object target) {
            ...
            if (mSetter != null) {
                try {
                    ...
                    mSetter.invoke(target, mTmpValueArray);//动画过程中,设置目标的当前属性值
                } catch (InvocationTargetException e) {
                    Log.e("PropertyValuesHolder", e.toString());
                } catch (IllegalAccessException e) {
                    Log.e("PropertyValuesHolder", e.toString());
        ...
        void setupSetter(Class targetClass) {
            ...
            //    CLogUtils.d("PropertyValuesHolder",
