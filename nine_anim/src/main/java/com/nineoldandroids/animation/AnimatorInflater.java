...
public class AnimatorInflater {
     ...
     */
    public static com.nineoldandroids.animation.Animator loadAnimator(Context context, int id)
    ...
    private static com.nineoldandroids.animation.Animator createAnimatorFromXml(Context c, XmlPullParser parser)
    ...
    private static com.nineoldandroids.animation.Animator createAnimatorFromXml(Context c, XmlPullParser parser,
                                                                                AttributeSet attrs, com.nineoldandroids.animation.AnimatorSet parent, int sequenceOrdering)
            throws XmlPullParserException, IOException {

        com.nineoldandroids.animation.Animator anim = null;
        ArrayList<com.nineoldandroids.animation.Animator> childAnims = null;
        ...
        while (((type=parser.next()) != XmlPullParser.END_TAG || parser.getDepth() > depth)
            ...
            if (name.equals("objectAnimator")) {
                ...
                createAnimatorFromXml(c, parser, attrs, (com.nineoldandroids.animation.AnimatorSet) anim,  ordering);
                a.recycle();
            } else {
            ...
            if (parent != null) {
                if (childAnims == null) {
                    childAnims = new ArrayList<com.nineoldandroids.animation.Animator>();
                }
                childAnims.add(anim);
            }
        }
        if (parent != null && childAnims != null) {
            com.nineoldandroids.animation.Animator[] animsArray = new Animator[childAnims.size()];
            int index = 0;
            for (com.nineoldandroids.animation.Animator a : childAnims) {
                animsArray[index++] = a;
            }
